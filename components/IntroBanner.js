export default function IntoBanner() {
    return (
        <section className="bg-white dark:bg-gray-900 max-w-screen-xl mx-auto p-8 md:p-12 lg:p-20">
            <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">Building a Secure <br /> <div className="text-transparent bg-clip-text bg-gradient-to-r to-orange-400 from-orange-600 block py-3">Cyber Future</div></h1>
